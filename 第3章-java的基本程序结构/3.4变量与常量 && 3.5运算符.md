...
![数据类型之间合法转换](https://cdn.jsdelivr.net/gh/RuiqiVan/core_java_I_img/res/unit3/conversion_between_values.png) 
...
圆括号内优先级最高,如int x=(1+2)*3;x就是9    
 ![运算符优先级](https://cdn.jsdelivr.net/gh/RuiqiVan/core_java_I_img/res/unit3/Operator_Priority.png)  
ps:优先级从高到低  
![显示不出来？](res/conversion_between_values.png)
